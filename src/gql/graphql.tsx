...
export type LaunchDetailsQuery = (
  ...
  & { launch?: Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'details' | 'id' | 'launch_date_utc' | 'mission_name'>
    & { launch_site?: Maybe<(
      { __typename?: 'LaunchSite' }
      & Pick<LaunchSite, 'site_name_long' | 'site_name'>
    )>, links?: Maybe<(
      { __typename?: 'LaunchLinks' }
      & Pick<LaunchLinks, 'flickr_images' | 'article_link' | 'mission_patch' | 'video_link'>
    )>, rocket?: Maybe<(
      { __typename?: 'LaunchRocket' }
...
export function usePastLaunchesListQuery(baseOptions: Apollo.QueryHookOptions<PastLaunchesListQuery, PastLaunchesListQueryVariables>) {
        return Apollo.useQuery<PastLaunchesListQuery, PastLaunchesListQueryVariables>(PastLaunchesListDocument, baseOptions);
      }
export function usePastLaunchesListLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<PastLaunchesListQuery, PastLaunchesListQueryVariables>) {
          return Apollo.useLazyQuery<PastLaunchesListQuery, PastLaunchesListQueryVariables>(PastLaunchesListDocument, baseOptions);
        }
